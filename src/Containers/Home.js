...
function Home() {
  useEffect(() => {
    axios
      .get("https://5ffeb221a4a0dd001701ae6f.mockapi.io/home")
  ...
  const handleResume = () => {
    window.open(
      "https://drive.google.com/file/d/15C-Gu1tC3obNOKn8qmpsYEoJFpagd9Ym/view?usp=sharing"
    );
  };
            ...
            <div className="home-text-effect">
              <h1>
                ...
                <a
                  ...
                  class="typewrite"
                  data-period="2000"
                  data-type='["developer","problem-solver","learner","doer","believer"]'
                >
